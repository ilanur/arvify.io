export default [
	...
	},
	{
		...
		description:
			'MCP of MCPs. A central hub for MCP servers. Helps you discover available MCP servers and learn how to install and use them.',
		category: '🔗 Aggregators',
	...
	},
	{
		...
		badges: ['🎖️', '📇', '☁️'],
		features: ['Blockchain integration', 'Wallet management', 'Smart contracts', 'DeFi operations']
	},
	{
		id: 'chess-mcp',
	...
	},
	{
		...
		description:
			'A Model Context Protocol server for Mem0 that helps manage coding preferences and patterns, providing tools for storing, retrieving and semantically searching memories.',
